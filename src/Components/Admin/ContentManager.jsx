...
const ContentManager = () => {
  ...
  // ── Reset ─────────────────────────────────────────────────────────────────────
  const openReset = (section) => setResetModal({ open: true, section });
                ...
                <form onSubmit={onSaveAbout}>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <TechInput label="DISPLAY_TITLE" value={about.title}
                      onChange={e => setAbout({ ...about, title: e.target.value })} placeholder="e.g. About Me" />
                    <TechInput label="SUBTITLE_ROLE" value={about.subtitle}
                      onChange={e => setAbout({ ...about, subtitle: e.target.value })} placeholder="e.g. Full Stack Developer" />
                  </div>
                  <TechInput label="CORE_DESCRIPTION" value={about.description}
                    onChange={e => setAbout({ ...about, description: e.target.value })} type="textarea" placeholder="Enter main biography..." />
                  <TechInput label="SKILL_MATRIX (CSV)" value={about.skills}
                    onChange={e => setAbout({ ...about, skills: e.target.value })} placeholder="React, Node, AI, etc." />
