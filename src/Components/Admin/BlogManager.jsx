...
import { getDefaultBlogs, addDefaultBlog, updateDefaultBlog, deleteDefaultBlog, resetSectionToDefault } from '../../utils/defaultsManager';
...
const BlogManager = () => {
  ...
  const openDeleteModal = (blog) => setDeleteModal({ open: true, blogId: blog.id, blogTitle: blog.title });
