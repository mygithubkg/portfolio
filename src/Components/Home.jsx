      ...
      >
        ...
        <div className="w-[90%] md:w-[85%] mx-auto relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-8 items-center mt-12 md:mt-0">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8 relative z-20">
            ...
            >
              <Link to="/projects" className="group flex items-center justify-center gap-3 w-full md:w-auto px-8 py-5 md:py-4 rounded-3xl md:rounded-full bg-white text-black font-bold text-sm hover:bg-cyan-400 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95">
                VIEW SYSTEMS
                <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/contact" className="group flex items-center justify-center gap-3 w-full md:w-auto px-8 py-5 md:py-4 rounded-3xl md:rounded-full bg-white/[0.03] border border-white/10 text-white font-bold text-sm hover:bg-white/10 transition-colors active:scale-95">
          ...
          */}
          <div className="flex md:grid md:grid-cols-3 gap-4 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none pb-8 md:pb-0 -mx-5 px-5 md:mx-0 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            >
              ...
              <Link to="/contact" className="px-6 py-3 rounded-full bg-white/10 hover:bg-white text-white hover:text-black font-bold text-sm transition-all whitespace-nowrap text-center">
                Let's Collaborate
              </Link>
            </motion.div>
          ...
          <div className="md:hidden mt-4 bg-gradient-to-br from-cyan-900/20 to-[#0a0a0c] border border-white/5 rounded-3xl p-6 flex flex-col gap-4">
            ...
            <Link to="/contact" className="px-6 py-4 rounded-full bg-white text-black font-bold text-xs transition-all text-center active:scale-95">
              Let's Collaborate
            </Link>
          </div>
